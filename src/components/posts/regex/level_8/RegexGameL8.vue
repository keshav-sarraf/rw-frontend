...
<div class="container">
    ...
    <regex-game-header title="The ?" :timeLimit=180 :finishedProgressPercent=100*7/16 :currentProgressPercent=100*1/15 :startTimer="levelStarted && !levelFinished" @time-elapsed="onTimeElapse" @timer-restarted="onTimerRestart" :resetTimer="resetTimer" />

    <div v-if="levelFinished">
        <div class="alert alert-success" role="alert">
            We'll let you know if we find a clue in these websites. We have few more recovered items for which we might need your help.
        </div>
