...
<div class="container">
    ...
    <regex-game-header title="The Message" :timeLimit=300 :finishedProgressPercent=100*14/16 :currentProgressPercent=100*1/16 :startTimer="levelStarted && !levelFinished" @time-elapsed="onTimeElapse" @timer-restarted="onTimerRestart" :resetTimer="resetTimer" />
