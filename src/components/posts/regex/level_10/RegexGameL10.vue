...
<div class="container">
    ...
    <regex-game-header title="The Parentheses ()" :timeLimit=180 :finishedProgressPercent=100*9/16 :currentProgressPercent=100*1/15 :startTimer="levelStarted && !levelFinished" @time-elapsed="onTimeElapse" @timer-restarted="onTimerRestart" :resetTimer="resetTimer" />
