...
<div>
    ...
    <p>
        We have received information that the attack would happen in batches and the first wave would hit all the servers which have  ".8" in their addresses.
    </p>
...
export default {
    ...
    setup(props, context) {
        ...
        const targetRegex = new RegExp("[.]8");
