...
<div class="container">
    ...
    <regex-game-header title="[ ] Character Sets" :timeLimit=10*60 :finishedProgressPercent=100*1/16 :currentProgressPercent=100*1/15 :startTimer="levelStarted && !levelFinished" @time-elapsed="onTimeElapse" @timer-restarted="onTimerRestart" :resetTimer="resetTimer" />
