...
<div>
    ...
    <h5>Repetitions</h5>
    <p>
        The meta characters <code>+</code>, <code>*</code> or <code>?</code> in some way or form are used to specify repeatitions of a pattern. Although broadly being linked to repetitions, these 3 meta characters serve slightly different purposes. Let's start with <code>*</code>
    </p>
