...
<div class="container">
    ...
    <regex-game-header title="Looking Around" :timeLimit=300 :finishedProgressPercent=100*13/16 :currentProgressPercent=100*1/15 :startTimer="levelStarted && !levelFinished" @time-elapsed="onTimeElapse" @timer-restarted="onTimerRestart" :resetTimer="resetTimer" />
